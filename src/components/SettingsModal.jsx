...
export const SettingsModal = ({ isOpen, onClose, activeSection }) => {
  ...
  const speechGuides = {
    ta: {
      ...
      default: "FINORA-விற்கு நல்வரவு. உங்களுக்கான அரசு சலுகைக் கடன் திட்டத்தை அறியவும், மாதாந்திர தவணையை கணக்கிடவும், மற்றும் அருகிலுள்ள வங்கிக் கிளையைக் கண்டறியவும்."
    },
    hi: {
      ...
      default: "FINORA में आपका स्वागत है। अपनी सरकारी कम ब्याज ऋण योजना जानने के लिए 4 आसान सवालों के जवाब दें, मासिक किस्त जानें और नजदीकी बैंक शाखा खोजें।"
    },
    te: {
      ...
      default: "FINORA కు స్వాగతం. మీ వ్యాపారం లేదా చదువుకు తగిన ప్రభుత్వ రాయితీ రుణాన్ని తెలుసుకోవడానికి 4 సాధారణ ప్రశ్నలకు సమాధానం ఇవ్వండి, నెలవారీ వాయిదా లెక్కించండి మరియు సమీప బ్యాంక్ శాఖను కనుగొనండి."
    },
    kn: {
      ...
      default: "FINORA ಗೆ ಸುಸ್ವಾಗತ. ನಿಮ್ಮ ಸರ್ಕಾರಿ ರಿಯಾಯಿತಿ ಸಾಲ ಯೋಜನೆಯನ್ನು ತಿಳಿಯಲು 4 ಸರಳ ಪ್ರಶ್ನೆಗಳಿಗೆ ಉತ್ತರಿಸಿ, ಮಾಸಿಕ ಕಂತು ಲೆಕ್ಕ ಹಾಕಿ ಮತ್ತು ಹತ್ತಿರದ ಬ್ಯಾಂಕ್ ಶಾಖೆಯನ್ನು ಹುಡುಕಿ."
    },
    ml: {
      ...
      default: "FINORA-ലേക്ക് സ്വാഗതം. നിങ്ങളുടെ സർക്കാർ സബ്‌സിഡി വായ്പ അറിയാൻ 4 ലളിതമായ ചോദ്യങ്ങൾക്ക് ഉത്തരം നൽകുക, പ്രതിമാസ തവണ കണക്കാക്കുക, അടുത്തുള്ള ബാങ്ക് കണ്ടെത്തുക."
    },
    en: {
      ...
      default: "Welcome to FINORA. Answer 4 simple questions to find your low-interest government loan, calculate your monthly EMI, and find an authorized bank near you."
    }
  };
